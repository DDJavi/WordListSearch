...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    public static final String wordExtra = "WORD";
    public static final String positionExtra = "POSITION";
    ...
    public void onBindViewHolder(final WordViewHolder holder, int position) {
        ...
        holder.edit_button.setOnClickListener(new MyButtonOnClickListener(current.getId(), current.getWord()) {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(positionExtra, holder.getAdapterPosition());
                intent.putExtra(wordExtra, word);
                ((Activity) mContext).startActivityForResult(intent, MainActivity.editWord);
            }
        });
    }
